...
fireworks_reimagined.register_firework_entity("fireworks_reimagined:test_firework_entity", {
	...
	firework_explosion = function(pos)
		core.chat_send_all("Custom explosion at " .. core.pos_to_string(pos) .. " with shape " .. shape)
	end
})

fireworks_reimagined.register_firework_entity("fireworks_reimagined:test_firework_entity_2", {
	firework_explosion = function(pos)
		fireworks_reimagined.spawn_firework_explosion(pos, "chaotic", nil, "#FFFFFF", "#FF0000", "255", nil, nil)
	end
})
...
fireworks_reimagined.register_firework_entity("fireworks_reimagined:test_3_firework_entity", {
	spiral = true,
	firework_explosion = function(pos)
		fireworks_reimagined.spawn_firework_explosion(pos, "chaotic", nil, "#FF0000", "#FF0000", "255", nil, nil)
	end
})
...
fireworks_reimagined.register_firework_entity("fireworks_reimagined:test_4_firework_entity", {
	spiral = true,
	firework_explosion = function(pos)
		fireworks_reimagined.spawn_firework_explosion(pos, "chaotic", nil, "#FFFF00", "#FFFF00", "255", "fireworks_redo_particle2.png", math.random(3,4))
	end
})
...
fireworks_reimagined.register_firework_entity("fireworks_reimagined:test_5_firework_entity", {
	spiral = true,
	firework_explosion = function(pos)
		fireworks_reimagined.spawn_firework_explosion(pos, "chaotic", nil, "#00FFFF", "#00FFFF", "255", "fireworks_spark_white.png", math.random(5,6))
	end
})
